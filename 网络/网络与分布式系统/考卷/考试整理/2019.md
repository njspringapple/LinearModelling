...
I=a×LR=10000×800×8 bit100×106 bit/s=64×106100×106=0.64I = \frac{a \times L}{R} = \frac{10000 \times 800 \times 8 \text{ bit}}{100 \times 10^6 \text{ bit/s}} = \frac{64 \times 10^6}{100 \times 10^6} = 0.64I=Ra×L​=100×106 bit/s10000×800×8 bit​=100×10664×106​=0.64
...
1. 帧传输时间：  
    tframe=512×8107=4096107=409.6μst_{frame} = \frac{512 \times 8}{10^7} = \frac{4096}{10^7} = 409.6 \mu stframe​=107512×8​=1074096​=409.6μs
    
2. 冲突检测要求：  
    2×tprop≤tframe2 \times t_{prop} \leq t_{frame}2×tprop​≤tframe​  
    tprop≤409.62=204.8μst_{prop} \leq \frac{409.6}{2} = 204.8 \mu stprop​≤2409.6​=204.8μs
    
3. 最大距离：  
    dmax=tprop×v=204.8×10−6×2×108=40960m=40.96 kmd_{max} = t_{prop} \times v = 204.8 \times 10^{-6} \times 2 \times 10^8 = 40960 m = \textbf{40.96 km}dmax​=tprop​×v=204.8×10−6×2×108=40960m=40.96 km
